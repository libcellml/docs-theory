...
extlinks = {
    ...
    'git_kracken': ('https://www.gitkraken.com/%s',''),
    'git_scm': ('https://git-scm.com/%s',''),
    'git_windows': ('http://gitforwindows.org/%s',''),
    ...
    'ninja': ('https://ninja-build.org/%s', ''),
    'ninja_download': ('https://github.com/ninja-build/ninja/releases%s', ''),
