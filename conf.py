...
extlinks = {
    ...
    'hh_tutorial': ('https://libcellml.org/documentation/latest/tutorials/hh_tutorial%s/index', 'HH Tutorial %s'),
    'solver': ('https://libcellml.org/documentation/solver%s', ''),
    'tutorial': ('https://libcellml.org/documentation/latest/tutorials/tutorial%s/index', 'Tutorial %s'),
}


# General information about the project.
project = u'libCellML Modelling Theory'
...
latex_documents = [
    ('index', 'libCellML.tex', u'libCellML Tutorials',
